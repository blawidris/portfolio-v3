...
export default function ConfirmModal({ isOpen, onConfirm, onCancel, label = "this item" }: ConfirmModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div role="dialog" aria-modal="true" aria-labelledby="confirm-dialog-title" className="relative bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-6 w-full max-w-sm mx-4 shadow-2xl">
        <h3 id="confirm-dialog-title" className="text-[var(--text-primary)] font-medium mb-2">Delete {label}?</h3>
